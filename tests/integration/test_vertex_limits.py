...
# Skip entire module if google-cloud-discoveryengine is not installed (Nix env)
pytest.importorskip("google.cloud.discoveryengine_v1", reason="google-cloud-discoveryengine not installed")
from google.api_core import exceptions  # noqa: E402

from cerebro.interfaces.llm import LLMProvider  # noqa: E402
from cerebro.providers.gcp.vertex_ai_llm import VertexAILLMProvider  # noqa: E402
